...
public class UnparsedAttribute extends AttributeInfo {
    ...
    public UnparsedAttribute(String attrName, int attrLen, ClassReader classReader, ConstantPool constantPool) {
        super(classReader, constantPool, attrName, attrLen);
    }

    @Override
    public void readInfo() throws Exception {
        this.bytes = this.getClassReader().readBytes(this.getAttrLen());
    }
}
